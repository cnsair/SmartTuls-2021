...
<!-- Fancybox -->
<!-- <link rel="stylesheet" href="../assets/fancybox/jquery.fancybox2e46.js"> -->
<!-- <script>
    //Fancybox init
    $("[data-fancybox]").fancybox();
</script> -->

<!-- JQuery and Bootstrap Resources -->
...
<!-- App UI Main Resources -->
<script type="text/javascript" src="../assets/scripts/main.07a59de7b920cd76b874.js"></script>

<!-- Other App Resources -->
<script type="text/javascript" src="../assets/plugins/summernote/summernote-lite.js"></script>
